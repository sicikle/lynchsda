...
class PostsControllerTest < ActionController::TestCase
  ...
  def test_anyone_can_list_the_posts
    get :index
    published = posts('codename-Lynchsda')
  ...
  def test_anyone_can_read_a_post
    get :show, slug: 'codename-Lynchsda'
    assert_response :ok
  end
  ...
  def test_haters_cannot_hate
    delete :destroy, slug: 'codename-Lynchsda'
    assert_response :unauthorized
  end
  ...
  def test_vandals_cannot_vandalize_by_updating
    put :update, slug: 'codename-Lynchsda', content: 'all your base are belong to us'
    assert_response :unauthorized
  end
